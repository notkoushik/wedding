  ...
  venues: [
    {
      ...
      date: '22nd August 2026',
      time: 'Night 11:59 hrs (Feast from 8:00 PM)',
      map: 'https://maps.google.com/?q=I+Conventions+Chanda+Nagar+Ameenpur+Hyderabad',
      uberLink: 'https://m.uber.com/ul/?action=setPickup&dropoff[formatted_address]=I%20Conventions%2C%20Chanda%20Nagar%2C%20Ameenpur%2C%20Hyderabad',
      appleMapsLink: 'https://maps.apple.com/?q=I+Conventions+Chanda+Nagar+Hyderabad',
      parkingInfo: 'Dedicated Car Parking Area Available inside Convention Grounds with Valet Guidance',
      gateInfo: 'Main Archway Gate · Entrance on Sri Devi Theatre Road',
      icon: '🏛️',
    },
    {
      ...
      uberLink: 'https://m.uber.com/ul/?action=setPickup&dropoff[formatted_address]=Sri%20Sai%20Surya%20Function%20Hall%2C%20Madhuravada%2C%20Visakhapatnam',
      appleMapsLink: 'https://maps.apple.com/?q=Sri+Sai+Surya+Function+Hall+Visakhapatnam',
      parkingInfo: 'Spacious Hall Parking Lot with Road-side Valet',
      gateInfo: 'Grand Entrance facing NH-16 Highway Service Road',
      icon: '🌸',
    },
  ],
